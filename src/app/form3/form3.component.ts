...
export class Form3Component implements OnInit {
  ...
  listMarks6(): any {
    ...
    deleteMark2(id: number) {
      if (confirm("Confirm delete")) {
        this.api.deleteMark3(id).subscribe({
          next: (res) => {
    ...
    deleteMark22(id: number) {
      if (confirm("Confirm delete")) {
        ...
        this.api.deleteMark32(id).subscribe({
          next: (res) => {
    ...
    deleteMark23(id: number) {
      if (confirm("Confirm delete")) {
        ...
        this.api.deleteMark33(id).subscribe({
          next: (res) => {
    ...
    deleteMark24(id: number) {
      if (confirm("Confirm delete")) {
        ...
        this.api.deleteMark34(id).subscribe({
          next: (res) => {
    ...
    deleteMark25(id: number) {
      if (confirm("Confirm delete")) {
        ...
        this.api.deleteMark35(id).subscribe({
          next: (res) => {
    ...
    deleteMark26(id: number) {
      ...
      if (confirm("Confirm delete")) {
        ...
        this.api.deleteMark36(id).subscribe({
          next: (res) => {
  ...
  deleteAll1() {
    if (confirm("You want to delete all marks for 1st sequence?")) {
      for (let i = 0; i < 30; i++) {
        this.api.deleteMark3(i).subscribe({
          next: (res) => {
  ...
  deleteAll2() {
    if (confirm("You want to delete all marks for 2nd sequence?")) {
      for (let i = 0; i < 30; i++) {
        this.api.deleteMark32(i).subscribe({
          next: (res) => {
            // console.log("All 1st sequence marks have been removed")
            this.listMarks2();
          },
  ...
  deleteAll3() {
    if (confirm("You want to delete all marks for 3rd sequence?")) {
      for (let i = 0; i < 30; i++) {
        this.api.deleteMark33(i).subscribe({
          next: (res) => {
            // console.log("All 1st sequence marks have been removed")
            this.listMarks3();
          },
  ...
  deleteAll4() {
    if (confirm("You want to delete all marks for 4th sequence?")) {
      for (let i = 0; i < 30; i++) {
        this.api.deleteMark34(i).subscribe({
          next: (res) => {
            // console.log("All 1st sequence marks have been removed")
            this.listMarks4();
          },
  ...
  deleteAll5() {
    if (confirm("You want to delete all marks for 5th sequence?")) {
      for (let i = 0; i < 30; i++) {
        this.api.deleteMark35(i).subscribe({
          next: (res) => {
            // console.log("All 1st sequence marks have been removed")
            this.listMarks5();
          },
  ...
  deleteAll6() {
    if (confirm("You want to delete all marks for 6th sequence?")) {
      for (let i = 0; i < 30; i++) {
        this.api.deleteMark36(i).subscribe({
          next: (res) => {
            // console.log("All 1st sequence marks have been removed")
            this.listMarks6();
          },
