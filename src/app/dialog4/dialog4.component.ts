...
export class Dialog4Component implements OnInit {
  ...
  constructor(private formbuilder: FormBuilder, private api: ApiService, @Inject(MAT_DIALOG_DATA) public editData: any, private dialogRef: MatDialogRef<Dialog4Component>) { }
  ...
  ngOnInit(): void {
    ...
    /*this.markForm = this.formbuilder.group({
      name7: new FormControl({value: '', disabled: true})
    });*/
    // this.verifySubject();
    ...
    // this.verifySubject('name6')
    // this.verifySubject('name7')
  ...
  verifySubject() {
    if (this.markForm.value.subjectName === "hist" || this.markForm.value.subjectName === "lit" ) {
      this.markForm.controls['name1'].enable()
      this.markForm.controls['name2'].enable()
      this.markForm.controls['name3'].enable()
      this.markForm.controls['name4'].enable()
      this.markForm.controls['name5'].enable()

      this.markForm.controls['name6'].disable()
      this.markForm.controls['name7'].disable()
      this.markForm.value['name6'] = ''
      this.markForm.value['name7'] = ''
      // console.log("Supposed to be disabled!")
    }
    else if (this.markForm.value.subjectName === "phy" || this.markForm.value.subjectName === "chem") {
      this.markForm.controls['name1'].disable()
      this.markForm.controls['name2'].disable()
      this.markForm.controls['name3'].disable()
      this.markForm.controls['name4'].disable()
      this.markForm.controls['name5'].disable()

      this.markForm.controls['name6'].enable()
      this.markForm.controls['name7'].enable()
      this.markForm.value['name1'] = ''
      this.markForm.value['name2'] = ''
      this.markForm.value['name3'] = ''
      this.markForm.value['name4'] = ''
      this.markForm.value['name5'] = ''
    }
    else {
      this.markForm.controls['name1'].enable()
      this.markForm.controls['name2'].enable()
  ...
  // verifyArtSubject() {
  //   if (this.markForm.value.subjectName === "phy" || this.markForm.value.subjectName === "chem") {
  //     this.markForm.controls['name6'].disable()
  //     this.markForm.controls['name7'].disable()
  //     this.markForm.value['name6'] = ''
  //     this.markForm.value['name7'] = ''
  ...
  updateMark2() {
    if (this.checkUpdate() != -1) {
      ...
      this.api.putMark4(this.markForm.value, this.editData.id)
        .subscribe({
          next: (res) => {
  ...
  updateMark22() {
    if (this.checkUpdate22() != -1) {
      ...
      this.api.putMark42(this.markForm.value, this.editData.id)
        .subscribe({
          next: (res) => {
            alert("Marks updated successfully!");
            this.markForm.reset();
  ...
  updateMark23() {
    if (this.checkUpdate23() != -1) {
      ...
      this.api.putMark43(this.markForm.value, this.editData.id)
        .subscribe({
          next: (res) => {
            alert("Marks updated successfully!");
            this.markForm.reset();
  ...
  updateMark24() {
    if (this.checkUpdate24() != -1) {
      ...
      this.api.putMark44(this.markForm.value, this.editData.id)
        .subscribe({
          next: (res) => {
            alert("Marks updated successfully!");
            this.markForm.reset();
  ...
  updateMark25() {
    if (this.checkUpdate25() != -1) {
      ...
      this.api.putMark45(this.markForm.value, this.editData.id)
        .subscribe({
          next: (res) => {
            alert("Marks updated successfully!");
            this.markForm.reset();
  ...
  updateMark26() {
    if (this.checkUpdate26() != -1) {
      ...
      this.api.putMark46(this.markForm.value, this.editData.id)
        .subscribe({
          next: (res) => {
            alert("Marks updated successfully!");
            this.markForm.reset();
  ...
  addMark2() {
    ...
    if (this.markForm.valid) {
      ...
      if (this.checkMarks() != -1) {
        ...
        this.api.postMark4(this.markForm.value)
          .subscribe({
            next: (res) => {
              this.markList = res;
  ...
  addMark22() {
    if (this.markForm.valid) {
      ...
      if (this.checkMarks22() != -1) {
        ...
        this.api.postMark42(this.markForm.value)
          .subscribe({
            next: (res) => {
              this.markList = res;
              alert(this.markForm.value.subjectName.toUpperCase() + " marks  added successfully  for " + this.markForm.value.sequenceName.toUpperCase());
  ...
  addMark23() {
    if (this.markForm.valid) {
      ...
      if (this.checkMarks23() != -1) {
        ...
        this.api.postMark43(this.markForm.value)
          .subscribe({
            next: (res) => {
              this.markList = res;
              alert(this.markForm.value.subjectName.toUpperCase() + " marks  added successfully for " + this.markForm.value.sequenceName.toUpperCase());
  ...
  addMark24() {
    if (this.markForm.valid) {
      ...
      if (this.checkMarks24() != -1) {
        ...
        this.api.postMark44(this.markForm.value)
          .subscribe({
            next: (res) => {
              this.markList = res;
              alert(this.markForm.value.subjectName.toUpperCase() + " marks  added successfully for " + this.markForm.value.sequenceName.toUpperCase());
  ...
  addMark25() {
    if (this.markForm.valid) {
      ...
      if (this.checkMarks25() != -1) {
        ...
        this.api.postMark45(this.markForm.value)
          .subscribe({
            next: (res) => {
              this.markList = res;
              alert(this.markForm.value.subjectName.toUpperCase() + " marks  added successfully for " + this.markForm.value.sequenceName.toUpperCase());
  ...
  addMark26() {
    if (this.markForm.valid) {
      ...
      if (this.checkMarks26() != -1) {
        ...
        this.api.postMark46(this.markForm.value)
          .subscribe({
            next: (res) => {
              this.markList = res;
              alert(this.markForm.value.subjectName.toUpperCase() + " marks  added successfully for " + this.markForm.value.sequenceName.toUpperCase());
