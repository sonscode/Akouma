...
export class Dialog2Component implements OnInit {
  ...
  constructor(private formbuilder: FormBuilder, private api: ApiService, @Inject(MAT_DIALOG_DATA) public editData: any, private dialogRef: MatDialogRef<Dialog2Component>) { }
...
updateMark2(){
  ...
  this.api.putMark2(this.markForm.value, this.editData.id)
  .subscribe({
    next: (res) => {
...
updateMark22(){
  ...
  this.api.putMark22(this.markForm.value, this.editData.id)
  .subscribe({
    next: (res) => {
      alert("Marks updated successfully!");
      this.markForm.reset();
...
updateMark23(){
  ...
  this.api.putMark23(this.markForm.value, this.editData.id)
  .subscribe({
    next: (res) => {
      alert("Marks updated successfully!");
      this.markForm.reset();
...
updateMark24(){
  ...
  this.api.putMark24(this.markForm.value, this.editData.id)
  .subscribe({
    next: (res) => {
      alert("Marks updated successfully!");
      this.markForm.reset();
...
updateMark25(){
  ...
  this.api.putMark25(this.markForm.value, this.editData.id)
  .subscribe({
    next: (res) => {
      alert("Marks updated successfully!");
      this.markForm.reset();
...
updateMark26(){
  ...
  this.api.putMark26(this.markForm.value, this.editData.id)
  .subscribe({
    next: (res) => {
      alert("Marks updated successfully!");
      this.markForm.reset();
  ...
  addMark2() {
    if (this.markForm.valid) {
      ...
      if (this.checkMarks() != -1) {
        ...
        this.api.postMark2(this.markForm.value)
          .subscribe({
            next: (res) => {
              this.markList = res;
  ...
  addMark22() {
    if (this.markForm.valid) {
      ...
      if (this.checkMarks22() != -1) {
        ...
        this.api.postMark22(this.markForm.value)
          .subscribe({
            next: (res) => {
              this.markList = res;
              alert(this.markForm.value.subjectName.toUpperCase() + " marks  added successfully  for " + this.markForm.value.sequenceName.toUpperCase());
  ...
  addMark23() {
    if (this.markForm.valid) {
      ...
      if (this.checkMarks23() != -1) {
        ...
        this.api.postMark23(this.markForm.value)
          .subscribe({
            next: (res) => {
              this.markList = res;
              alert(this.markForm.value.subjectName.toUpperCase() + " marks  added successfully for " + this.markForm.value.sequenceName.toUpperCase());
  ...
  addMark24() {
    if (this.markForm.valid) {
      ...
      if (this.checkMarks24() != -1) {
        ...
        this.api.postMark24(this.markForm.value)
          .subscribe({
            next: (res) => {
              this.markList = res;
              alert(this.markForm.value.subjectName.toUpperCase() + " marks  added successfully for " + this.markForm.value.sequenceName.toUpperCase());
  ...
  addMark25() {
    if (this.markForm.valid) {
      ...
      if (this.checkMarks25() != -1) {
        ...
        this.api.postMark25(this.markForm.value)
          .subscribe({
            next: (res) => {
              this.markList = res;
              alert(this.markForm.value.subjectName.toUpperCase() + " marks  added successfully for " + this.markForm.value.sequenceName.toUpperCase());
  ...
  addMark26() {
    if (this.markForm.valid) {
      ...
      if (this.checkMarks26() != -1) {
        ...
        this.api.postMark26(this.markForm.value)
          .subscribe({
            next: (res) => {
              this.markList = res;
              alert(this.markForm.value.subjectName.toUpperCase() + " marks  added successfully for " + this.markForm.value.sequenceName.toUpperCase());
